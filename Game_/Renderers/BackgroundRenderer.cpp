...
{
	BackgroundRenderer::BackgroundRenderer(const std::string& imagePath, float scrollSpeed)
		: imagePath_(imagePath), scrollSpeedMultiplier_(scrollSpeed)
	{
    ...
    void BackgroundRenderer::Draw(float cameraYaw)
    {
        ...
        // 計算參數
        float parallaxYaw = cameraYaw * scrollSpeedMultiplier_;
        ...
        glUniform2f(resLoc, 
            ...
            (float)Game::GameCore::RETRO_LAYOUT.sky);
